...
void InitTransformData(int x0, int y0, int x1, int y1,int size)
{
	...
	Transform.x0 = x0 + Transform.CenterX;
	Transform.y0 = y0 + Transform.CenterY;
	Transform.x1 = x1 + Transform.CenterX;
	Transform.y1 = y1 + Transform.CenterY;
